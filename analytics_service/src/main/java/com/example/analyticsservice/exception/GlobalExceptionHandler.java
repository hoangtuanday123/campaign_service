...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AnalyticsReportNotReadyException.class)
    public ResponseEntity<ApiResponse<Void>> handleReportNotReady(AnalyticsReportNotReadyException ex) {
